...
//                return Mathf.Max(Environment.ProcessorCount - 1, 1);
        ...
        {
            Log.LogFormat("[Main]", "HttpDownload.AddFile {0}", file);
        ...
        {
            Log.LogFormat("[Main]", "HttpDownload.RemoveFile Before {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);
            ...
            Log.LogFormat("[Main]", "HttpDownload.RemoveFile RemoveComplete {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);


            CheckLoadSizeThreadStart();
            CheckLoadThreadStart();

            Log.LogFormat("[Main]", "HttpDownload.RemoveFile End {0}, waitFileList.Count={1}, loadSizeFileList.Count={2}", file, waitFileList.Count, loadSizeFileList.Count);
        ...
        private void CheckLoadSizeThreadStart()
        {
            ...
            Log.LogFormat("[Main]", "HttpDownload.CheckLoadSizeThreadStart waitFileList.Count={0}, loadSizeThread.state={1}", waitFileList.Count, loadSizeThread.state);
        ...
        {
            Log.LogFormat("[Main]", "HttpDownload.CheckLoadThreadStart waitBlockList.Count={0}", waitBlockList.Count);
        ...
        public class LoadThread
        {
            ...
            public void Start()
            {
                ...
                Log.LogFormat("[LoadThread]", "Start Before {0}", this);
                ...
                Log.LogFormat("[LoadThread]", "Start After {0}", this);
            }


            public void Exit()
            {
                Log.LogFormat("[LoadThread]", "Exit Before {0}", this);
                ...
                Log.LogFormat("[LoadThread]", "Exit After {0}", this);
            }
            ...
            private void Run()
            {
                while(!isExit)
                {
                    ...
                    Log.LogFormat("[LoadThread]", "Run Doing Before {0}, httpDownload.waitBlockList.Count={1}", this, httpDownload.waitBlockList.Count);
                    ...
                    Log.LogFormat("[LoadThread]", "Run Doing After {0}, httpDownload.waitBlockList.Count={1}, block={2}", this, httpDownload.waitBlockList.Count, block);
                }

                state = StateType.End;
                thread = null;

                Log.LogFormat("[LoadThread]", "Run End {0}", this);
            }
        ...
        public class LoadSizeThread
        {
            ...
            public void Start()
            {
                ...
                Log.LogFormat("[LoadSizeThread]", "Start Before {0}", this);
                ...
                Log.LogFormat("[LoadSizeThread]", "Start After {0}", this);
            }


            public void Exit()
            {
                Log.LogFormat("[LoadSizeThread]", "Exit Before {0}", this);
                ...
                Log.LogFormat("[LoadSizeThread]", "Exit After {0}", this);
            }
            ...
            private void Run()
            {
                while(!isExit)
                {
                    ...
                    Log.LogFormat("[LoadSizeThread]", "Run Doing Before {0}, httpDownload.waitFileList.Count={1}, httpDownload.loadSizeFileList.Count={2}", this, httpDownload.waitFileList.Count, httpDownload.loadSizeFileList.Count);
                    ...
                    Log.LogFormat("[LoadSizeThread]", "Run Doing After {0}, httpDownload.waitFileList.Count={1}, httpDownload.loadSizeFileList.Count={2}", this, httpDownload.waitFileList.Count, httpDownload.loadSizeFileList.Count);
                }

                state = StateType.End;
                thread = null;

                Log.LogFormat("[LoadSizeThread]", "Run End {0}", this);
            }
